...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		// Leave this array empty to use the default favicon
		{
			...
			// sizes: "961x961", // (Optional) Size of the favicon, set only if you have favicons of different sizes
		},
	],
};
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/achcyano", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/357881354",
		},
		{
			name: "Telegram",
			icon: "jam:telegram",
			url: "https://t.me/achqing0769",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/profiles/76561199095842368",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/achcyano",
		},
	],
};
...
export const commentConfig: CommentConfig = {
	giscus: {
		repo: "achcyano/achcyano.github.io",
		repoId: "R_kgDOQRG0qg",
		category: "Announcements",
		categoryId: "DIC_kwDOQRG0qs4CxkNy",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "1",
